...
INSERT INTO offers (campaign_id, title, retailer, category_id, valid_days) VALUES
  ('33333333-3333-3333-3333-333333333333','30% dcto. leche deslactosada 1L','Éxito','comida_saludable',7)
ON CONFLICT DO NOTHING;
`;
